...
public class UserController {
    ...
    public ResponseEntity<HttpResponse> resetPasswordByKey(@PathVariable("key") String key,
                                                            @RequestBody ResetPasswordRequest request){
        userService.renewPassword(key, request.getPassword(), request.getConfirmPassword());
        return ResponseEntity.ok().body(
                HttpResponse.builder()
                        .timeStamp(now().toString())
    ...
    public ResponseEntity<HttpResponse> verifyAccountByKey(@PathVariable("key") String key){
        return ResponseEntity.ok().body(
                HttpResponse.builder()
                        .timeStamp(now().toString())
